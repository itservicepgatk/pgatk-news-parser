          ...
          <main className="flex-1 w-full order-2">
            <div className="bg-white rounded-xl shadow-xl border border-slate-100 overflow-hidden p-6 md:p-10">
              ...
              <div className="mb-16">
                ...
                <a 
                  href="https://pgatkk.by/images/VEkskursiy/gidro.html" 
                  target="_blank" 
...
with open('d:\\Workspace\\Web\\PGATK Website\\pages\\Facilities.tsx', 'w', encoding='utf-8') as f:
    f.write(content)

print("Created Facilities.tsx")
